        ...
        <>
          ...
          <div className="chat-message-left pb-4">
            ...
            <div className="flex-shrink-1 bg-light rounded py-2 px-3 ms-3">
              <div className="fw-bold mb-1">{props.displayName}</div>
              {props.msg.text}
            </div>
          </div>
        </>
...
function Messages() {
  ...
  const [user1Displayname, setUser1Displayname] = useState("");
  const [user1Pic, setUser1Pic] = useState("");
  const [user2Displayname, setUser2Displayname] = useState("");
  ...
  const clickUser = async (user) => {
    ...
    setUser1Displayname(user1Info.displayName);
    setUser1Pic(user1Info.profilePicture);
    setUser2Displayname(user2Info.displayName);
    setUser2Pic(user2Info.profilePicture);
                      ...
                      {msgs.length
                        ? msgs.map((msg, i) => (
                            <UserMsg
                              ...
                              profilePic={
                                msg.from === myEmail ? user1Pic : user2Pic
                              }
                              user1={myEmail}
                            />
                          ))
